...
function generateDialoguesForVillager1(): DialogueNode[] {
  ...
  return [
    ...
    { id: `${vid}_s5_good`, stage: 5, speaker: 'villager', text: '孩子，土地是不会骗人的。你对它用心，它就会给你最好的回报。去吧，去创造属于你的传奇！', autoNext: `${vid}_s5_end`, unlockOrderId: `${vid}_ex_5`, triggerAchievementId: 'villager_1_soulmate', triggerCodexId: `villager_${vid}_soulmate` },
...
function generateDialoguesForVillager2(): DialogueNode[] {
  ...
  return [
    ...
    { id: `${vid}_s5_good`, stage: 5, speaker: 'villager', text: '这是我王家三代人的心血。我没有后代，你就是我的亲孙子（孙女）。希望你能用它，给更多人带来幸福。', autoNext: `${vid}_s5_end`, unlockOrderId: `${vid}_ex_5`, triggerAchievementId: 'villager_2_soulmate', triggerCodexId: `villager_${vid}_soulmate` },
...
function generateDialoguesForVillager3(): DialogueNode[] {
  ...
  return [
    ...
    { id: `${vid}_s5_good`, stage: 5, speaker: 'villager', text: '从今以后，让我们一起用科学的力量，让家乡变得更好！这是我为我们的合作定制的"未来农场"计划，一起实现它吧！', autoNext: `${vid}_s5_end`, unlockOrderId: `${vid}_ex_5`, triggerAchievementId: 'villager_3_soulmate', triggerCodexId: `villager_${vid}_soulmate` },
...
function generateBasicDialogues(vid: string, personality: string): DialogueNode[] {
  return [
    ...
    { id: `${vid}_s5_good`, stage: 5, speaker: 'villager', text: '这是我最珍贵的东西，现在它属于你了。无论发生什么，我们永远都是最好的朋友！', autoNext: `${vid}_s5_end`, unlockOrderId: `${vid}_ex_5`, triggerAchievementId: `villager_${vid.slice(-1)}_soulmate`, triggerCodexId: `villager_${vid}_soulmate` },
